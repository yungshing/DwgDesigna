...
//	textId = MyDrawEntity::DrawMText(pt, strText, m_dTxtHeight, textStyleId);
	...
	ini.GetValueOfKey(_T("文字设置"), _T("1"),sTextStyle);
...
// 	{
		...
		cenPt.z = 0;
		AcDbObjectId objId = CTextUtil::AddText(cenPt, _T("技术要求"), idTextStyle, m_dJsTxtHeight);
...
void CDlgJswz::OnBnClickedButtonSave()
{
	...
	strCurrentPath = CAppDirectoryUtil::GetCurrentDirectoryW()+ _T("技术文字\\");
